...
namespace MathHighLow.Views
{
    ...
    public class CardView : MonoBehaviour
    {
        ...
        [Header("카드 텍스트 색상")]
        [SerializeField] private Color playerNumberTextColor = Color.black; // ✅ 숫자 카드 텍스트 색 (검은색)
        [SerializeField] private Color playerOperatorTextColor = Color.black; // ✅ 연산자 카드 텍스트 색 (검은색)
        [SerializeField] private Color specialCardTextColor = Color.black; // ✅ 특수 카드 텍스트 색 (검은색)
        [SerializeField] private Color aiCardTextColor = Color.black; // ✅ AI 카드 텍스트 색 (검은색)
